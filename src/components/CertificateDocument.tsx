...
export const CertificateFrontPage: React.FC<CertificateDocumentProps> = ({ certificate, elementId = 'certificate-front-canvas', isCancelled = false }) => {
  const {
    ...
    signatoryName = 'Carlos Henrique Ferreira De Mello', signatoryRole = 'Diretor Geral', signatoryCpf = '981.050.007-68', signatureImageUrl, signatureMode = 'none', signatureScale = 100, signatureOffsetX = 0, signatureOffsetY = 0,
  } = certificate;
